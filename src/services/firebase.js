...
/*
    ...
    getPushingArray = () => this.database.ref(`/pushing/`);
    getConcreteGradeArray = () => this.database.ref(`/concreteGrade/`);
    getReinforcementGradeArray = () => this.database.ref(`/concreteGrade/`);
